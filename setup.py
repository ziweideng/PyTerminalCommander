...
setup(
    ...
    url='https://github.com/owwlo/PyTerminalCommander',

    # Author details
    author='owwlo',
    author_email='owwlo.g@gmail.com',
    ...
    keywords='shell gui command commander output log logger',
    ...
    # entry_points={
    #     'console_scripts': [
    #         'websocket_tester=WebSocketCommandline.websocket_tester:main'
    #     ],
    # },

    download_url = 'https://github.com/owwlo/PyTerminalCommander/tarball/{}'.format(VERSION),
)
